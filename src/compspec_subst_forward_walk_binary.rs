...
///  Binary right + combine. Takes t_l as param (caller computes left IH).
///  Match-based requires: compspec_iterate fact uses *left/*right from match.
///  NO Formula sub-terms in signature params.
